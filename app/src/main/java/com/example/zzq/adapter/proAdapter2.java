...
public class proAdapter2 extends BaseAdapter {
	...
	public proAdapter2(Context context, List<ConfigInfo> proList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = View.inflate(context, R.layout.pro_item, null);
	...
	class ProSucessNetTask extends AsyncTask<Object, Integer, String> {
		...
		protected String doInBackground(Object... params) {
			...
			url = Constants.proAdapter2UrlLHL;
